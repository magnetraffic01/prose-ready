import { Gavel, Language } from "./Icons";

export default function Footer() {
  return (
    <footer className="bg-slate-50/50 py-20 border-t border-slate-200/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Simulador de entrevistas de asilo impulsado por IA para ayudar a solicitantes de asilo a prepararse para su futuro.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <button className="flex items-center gap-2 text-sm text-slate-500 border border-slate-200 px-4 py-2 rounded-lg hover:bg-slate-50 transition-all">
        ...
        <div className="border-t border-slate-200 pt-8">
          <p className="text-[10px] text-slate-400 leading-relaxed max-w-4xl">
            DESCARGO DE RESPONSABILIDAD: ProSe Ready es una plataforma tecnológica y no es un bufete de abogados, no brinda asesoría legal y no es un sustituto de un abogado. No estamos afiliados, asociados, autorizados, respaldados ni conectados oficialmente con USCIS, ICE, el Departamento de Seguridad Nacional (DHS) ni ninguna otra agencia gubernamental de los Estados Unidos.
          </p>
