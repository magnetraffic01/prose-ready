import { Analytics, Psychology, ErrorIcon, AssignmentTurnedIn, Spa } from "./Icons";
...
const features = [
  ...
  { icon: AssignmentTurnedIn, title: "Sin improvisación", desc: "Llega preparado con respuestas claras y estructuradas legalmente." },
  { icon: Spa, title: "Calma total", desc: "Reduce la ansiedad practicando en un entorno seguro y privado." },
];
