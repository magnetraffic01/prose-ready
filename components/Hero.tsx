"use client";
import { VerifiedUser, PlayCircle, Warning } from "./Icons";

export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-20 pb-24 lg:pt-40 lg:pb-52 bg-gradient-to-b from-blue-50/50 to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-left">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-slate-900 leading-[1] mb-8">
        ...
        <div className="flex-1 w-full max-w-xl lg:max-w-none">
          <div className="relative rounded-2xl overflow-hidden border border-white/40 glass-card" style={{ backdropFilter: "blur(40px)", WebkitBackdropFilter: "blur(40px)" }}>
            <div className="bg-white p-4 border-b border-slate-200 flex items-center justify-between">
              ...
              <div className="text-xs font-medium text-slate-400 uppercase tracking-widest">Sesión de Simulación</div>
              <div className="w-10"></div>
            </div>
            <div className="bg-gradient-to-br from-slate-100 to-slate-200 h-64 flex items-center justify-center">
              <div className="text-center text-slate-400">
                <div className="w-20 h-20 rounded-full bg-slate-300 mx-auto mb-4 flex items-center justify-center">
                  <span className="text-3xl">👩‍💼</span>
                </div>
                <p className="text-sm font-medium">Simulación en progreso...</p>
              </div>
            </div>
            <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/90 backdrop-blur rounded-lg border border-primary/20 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
                <Warning className="w-5 h-5 text-primary" />
                <span className="font-bold text-sm">Alerta de Contradicción</span>
              </div>
