...
const plans = [
  {
    ...
    price: "$0",
    period: "",
    features: ["1 Simulación básica", "10 preguntas generales"],
    cta: "Probar ahora",
    highlight: false,
  },
  {
    ...
    price: "$29",
    period: "/mes",
    features: ["3 Simulaciones completas", "Detección de contradicciones", "Reporte básico de feedback"],
    cta: "Seleccionar",
    highlight: false,
  },
  {
    ...
    price: "$49",
    period: "/mes",
    features: ["10 Simulaciones completas", "Análisis profundo", "Guía de preguntas difíciles", "Soporte prioritario"],
    cta: "Seleccionar Pro",
    highlight: true,
  },
  {
    ...
    price: "$99",
    period: "/mes",
    features: ["Clientes ilimitados", "Dashboard de gestión", "Créditos IA extra"],
...
export default function Pricing() {
  return (
    <section className="py-32 bg-gradient-to-br from-blue-600 to-primary relative" id="planes">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {plans.map((plan) => (
            ...
            >
              {plan.highlight && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 glossy-primary text-[10px] font-black uppercase tracking-widest px-5 py-1.5 rounded-full">
                  Recomendado
                </div>
              )}
